        ...
        interfaceMgr = function() {
            ...
            function init() {
                $player = $(cssSelector.player),
                        $title = $player.find(cssSelector.caption),
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player row-fluid">' +
                        '  <div class="span12">'+
                        '    <div class="player jp-interface row-fluid">' +
                        '        <div class="album-cover span6">' +
                        ...
                        '            <h2 class="caption"></h2>' +
                        '            <div class="rating">' +
                        '                <i class="rating-level rating-star im-icon-star-3"></i>' +
                        '                <i class="rating-level rating-star im-icon-star-3"></i>' +
                        '                <i class="rating-level rating-star im-icon-star-3"></i>' +
                        '                <i class="rating-level rating-star im-icon-star-3"></i>' +
                        '                <i class="rating-level rating-star im-icon-star-3"></i>' +
                        '            </div>' +
                        '            <h6 class="tagline artist-outer"><span class="artist"></span></h6>' +
                        '        </div>' +
                        '        <div class="player-controls">' +
                        '            <div class="main">' +
                        '                <div class="previous jp-previous"><i class="im-icon-backward-2"></i></div>' +
                        '                <div class="play jp-play"><i class="im-icon-play-4"></i></div>' +
                        '                <div class="pause jp-pause"><i class="im-icon-pause-2"></i></div>' +
                        '                <div class="next jp-next"><i class="im-icon-forward-3"></i></div>' +
                        '                    <div class="jp-mute"><i class="im-icon-volume-mute-4"></i></div>' +
                        '                    <div class="jp-unmute"><i class="im-icon-volume-high-2"></i></div>' +
                        // '                    <span class="jp-volume-bar"><i class="fa-icon-volume-down"></i></span>' +
                        // '                    <span class="jp-volume-bar-value"><i class="fa-icon-volume-off"></i></span>' +
                        // '                    <span class="jp-volume-max"><i class="fa-icon-volume-up"></i></span>' +
                        ...
                        '                </div>' +
                        '            </div>' +
                        '            <div class="duration jp-duration"></div>'+
                        '            </div>' +
                        '    <div class="tracklist">' +
                        '        <ol class="tracks"> </ol>' +
                        '        <div class="btn2 more"><i class="im-icon-stack-2"></i></div>' +
                        '    </div>' +
            ...
            function setCover() {
                ...
                if (!isUndefined(myPlaylist[current].cover)) {
                    var new_cover = $('<img src="' + myPlaylist[current].cover + '" alt="album cover" />');
                    $albumCover.html(new_cover);
                }
/*
