...
?>
    <div class="row short-article <?php echo $article_class; ?>">
        <div class="span1">
          <div class="date-post">
...
<?php 
    ...
    miss_after_post(); 
    ?>
          <!--div class="post_grid_image has_preview">
            <img class="hover_fade_js image-resize w" src="http://scrollax.mnb-t.com/wp-content/uploads/cache/d/da0203ed10deaf155819de8d6b60ee7f.jpg" title="Beauty" alt="Top Flight Heli3" width="790" height="940" />
            <div class="preview_info_wrap">
                <a class="controls img" href="http://scrollax.mnb-t.com/wp-content/uploads/2013/04/top-flight-heli3.jpg" rel="prettyPhoto[portfolio_2646]"><i class="im-icon-zoom-in"></i></a>
            </div>
          </div-->
