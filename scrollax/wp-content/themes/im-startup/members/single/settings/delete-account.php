		...
		<div id="item-body" role="main" class="clearfix">
			...
			<form action="<?php  echo bp_displayed_user_domain() . bp_get_settings_slug() . '/delete-account'; ?>" name="account-delete-form" id="account-delete-form" class="standard-form" method="post">
				...
				<div class="entry-content">
					<p>
						<input type="checkbox" name="delete-account-understand" id="delete-account-understand" value="1" onclick="if(this.checked) { document.getElementById('delete-account-button').disabled = ''; } else { document.getElementById('delete-account-button').disabled = 'disabled'; }" /> <label for="delete-account-understand"><?php  _e( 'I understand the consequences of deleting my account.', 'buddypress' ); ?></label>
					</p>
