...
class IrishMissW_Contact_Form_Widget extends WP_Widget {
    
	/**
	 *
	 */
    function IrishMissW_Contact_Form_Widget() {
		$widget_ops = array( 'classname' => 'miss_contact_form_widget', 'description' => __( 'Quickly add a contact form to your sidebar', MISS_ADMIN_TEXTDOMAIN ) );
		$control_ops = array( 'width' => 200, 'height' => 200 );
		$this->WP_Widget( 'contact_form', sprintf( __( '%1$s - Contact Form', MISS_ADMIN_TEXTDOMAIN ), THEME_NAME ), $widget_ops, $control_ops );
    }
    ...
    function form($instance) {				
		...
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e( 'Email:', MISS_ADMIN_TEXTDOMAIN ); ?></label>
		...
		<label for="<?php echo $this->get_field_id('enable_captcha'); ?>"><?php _e( 'Enable Captcha?', MISS_ADMIN_TEXTDOMAIN ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id('enable_akismet'); ?>"><?php _e( 'Enable Akismet?', MISS_ADMIN_TEXTDOMAIN ); ?></label></p>
