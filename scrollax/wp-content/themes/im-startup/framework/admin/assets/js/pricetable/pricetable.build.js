...
jQuery(function($){
	...
	resetColumns = function(){
		//$('.price-columns').sortable('serialize');
		//$('.price-columns').sortable('refresh');
		/* var pos = $('.price-columns .column').offset(),
		    currentTop = pos.top;
		*/
		var currentTop = 0;
	...
	$('.price-columns textarea.autoresize').not('#column-skeleton textarea.autoresize').trigger('change');
