<?php
<h4><span><?php  _e( 'Change Avatar', 'buddypress' ) ?></span></h4>
...
<?php  if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p>
	  <?php
	    _e( 'Your avatar will be used on your profile and throughout the site. If there is a <a href="'.MISS_URL_GAVATAR.'">Gravatar</a> associated with your account email we will use that, or you can upload an image from your computer.', 'buddypress')
	   ?>
	</p>
...
<?php  else : ?>
	...
	<p><?php  _e( 'Your avatar will be used on your profile and throughout the site. To change your avatar, please create an account with <a href="'.MISS_URL_GAVATAR.'">Gravatar</a> using the same email address as you used to register with this site.', 'buddypress' ) ?></p>
