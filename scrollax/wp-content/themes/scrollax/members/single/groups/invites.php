	...
	<ul id="group-list" class="invites item-list">
		...
		<?php  while ( bp_groups() ) : bp_the_group(); ?>
			...
			<li>
				...
				<div class="action">
					<a class="button_link small_button accept" href="<?php  bp_group_accept_invite_link() ?>"><?php  _e( 'Accept', 'buddypress' ) ?></a> &nbsp;
					<a class="button_link small_button reject confirm" href="<?php  bp_group_reject_invite_link() ?>"><?php  _e( 'Reject', 'buddypress' ) ?></a>
...
<?php  else: ?>
	...
	<div class="divider noline"></div>
	<?php echo do_shortcode('[alertbox1 close="true"]' .__( 'You have no outstanding group invites.', 'buddypress' ) . '[/alertbox1]' ); ?>
