<div class="entry-content">
	...
	<form action="<?php  bp_messages_form_action('compose') ?>" method="post" id="send_message_form" class="standard-form" role="main">
		...
		<div id="send-to">
			...
			<ul class="first acfb-holder">
				<li>
					...
					<input type="text" name="send-to-input" id="send-to-input" class="input-wrap" />
				</li>
			</ul>
		</div>
		...
		<p>
			...
			<input type="text" name="subject" id="subject" class="input-wrap" value="<?php  bp_messages_subject_value() ?>" />
		</p>

		<p>
			<label for="content"><?php  _e( 'Message', 'buddypress') ?></label><br />
			<textarea name="content" id="message_content" class="textarea input-wrap" rows="15" cols="40"><?php  bp_messages_content_value() ?></textarea>
		</p>
		...
		<p class="submit">
			<input type="submit" value="<?php  _e( "Send Message", 'buddypress' ) ?>" name="send" id="send" class="buttom_link small_button" />
		</p>
