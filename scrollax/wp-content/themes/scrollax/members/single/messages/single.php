			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						<h4><span><?php  _e( 'Send a Reply', 'buddypress' ) ?></span></h4>
					</div>
				...
				<div class="message-content">
					...
					<textarea name="content" id="message_content" class="textarea input-wrap" rows="15" cols="40"></textarea>

					<?php  do_action( 'bp_after_message_reply_box' ) ?>

					<div class="submit">
						<input type="submit" name="send" value="<?php  _e( 'Send Reply', 'buddypress' ) ?> &rarr;" id="send_reply_button" class="button_link small_button" />
