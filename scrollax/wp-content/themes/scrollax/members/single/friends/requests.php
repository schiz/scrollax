	...
	<ul id="friend-list" class="item-list">
		<?php  while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php  bp_friend_friendship_id() ?>">
				...
				<div class="action">
					<a class="button_link small_button accept" href="<?php  bp_friend_accept_request_link() ?>"><?php  _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
					<a class="button_link small_button reject" href="<?php  bp_friend_reject_request_link() ?>"><?php  _e( 'Reject', 'buddypress' ); ?></a>
...
<?php  else: ?>
	...
	<?php echo do_shortcode('[alertbox1 close="true"]' .__( 'You have no pending friendship requests.', 'buddypress' ) . '[/alertbox1]' ); ?>
