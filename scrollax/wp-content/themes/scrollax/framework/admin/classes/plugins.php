...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function __construct() {
			...
			define( 'MISS_TGM_TEXTDOMAIN', $this->domain );

			$this->strings = array(
				'page_title'                      => __( 'Install Required Plugins', MISS_TGM_TEXTDOMAIN ),
				'menu_title'                      => __( 'Install Plugins', MISS_TGM_TEXTDOMAIN ),
				'installing'                      => __( 'Installing Plugin: %s', MISS_TGM_TEXTDOMAIN ),
				'oops'                            => __( 'Something went wrong.', MISS_TGM_TEXTDOMAIN ),
				...
				'return'                          => __( 'Return to Required Plugins Installer', MISS_TGM_TEXTDOMAIN ),
				'plugin_activated'                => __( 'Plugin activated successfully.', MISS_TGM_TEXTDOMAIN ),
				'complete'                        => __( 'All plugins installed and activated successfully. %1$s', MISS_TGM_TEXTDOMAIN ),
			);
