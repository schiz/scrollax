...
(function($) {
	$(function() {
		$('div.share42init').each(function(idx) {
			...
			var s = new Array('"#" data-count="fb" onclick="window.open(\'http://www.facebook.com/sharer.php?' + fbQuery + '\', \'_blank\', \'scrollbars=0, resizable=1, menubar=0, left=100, top=100, width=550, height=440, toolbar=0, status=0\');return false" title="Поделиться в Facebook"',
            ...
            var l = '';
			for (j = 0; j < s.length; j++) l += '<span class="share42-item" style="display:inline-block;margin:0 6px 6px 0;height:30px;"><a rel="nofollow" style="display:inline-block;width:30px;height:30px;margin:0;padding:0;outline:none;background:url(' + f + 'icons.png) -' + 30 * j + 'px 0 no-repeat" href=' + s[j] + ' target="_blank"></a></span>';
