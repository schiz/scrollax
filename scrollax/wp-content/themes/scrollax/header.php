...
<head>
  ...
  <?php miss_head(); ?>
  <?php wp_head(); ?>
  <link rel='stylesheet' href='<?php echo THEME_URI; ?>/assets/styles/template.css' type='text/css' media='all' />
  <link rel='stylesheet' href='<?php echo THEME_URI; ?>/assets/styles/product.css' type='text/css' media='all' />
  ...
  <script src="<?php echo THEME_URI; ?>/assets/js/jquery.parallax.js"></script>
  <script src="<?php echo THEME_URI; ?>/assets/js/home-page.js"></script>
  <script src="<?php echo THEME_URI; ?>/assets/js/qoopido.emerge.1.2.2.js"></script>
