<?php  if ( bp_has_forum_topic_posts() ) : ?>
	...
	<form action="<?php  bp_forum_topic_action() ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div id="topic-meta">
			...
			<a class="button" href="<?php  bp_forum_permalink() ?>/">&larr; <?php  _e( 'Group Forum', 'buddypress' ) ?></a> &nbsp; <a class="button" href="<?php  bp_forums_directory_permalink() ?>/"><?php  _e( 'Group Forum Directory', 'buddypress') ?></a></span>
		...
		<?php  if ( bp_group_is_member() ) : ?>
			...
			<?php  if ( bp_is_edit_topic() ) : ?>
				...
				<div id="edit-topic">
					...
					<input type="text" name="topic_title" id="topic_title" class="input-wrap" value="<?php  bp_the_topic_title() ?>" />

					<label for="topic_text"><?php  _e( 'Content:', 'buddypress' ) ?></label>
					<textarea name="topic_text" id="topic_text" class="textarea input-wrap"><?php  bp_the_topic_text() ?></textarea>

					<?php  do_action( 'bp_group_after_edit_forum_topic' ) ?>

					<p class="submit"><input type="submit" name="save_changes" id="save_changes" class="button_link small_button" value="<?php  _e( 'Save Changes', 'buddypress' ) ?>" /></p>
