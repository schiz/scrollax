...
class miss_add_mce_button {
    ...
    function add_IgniterShortsPhotos_button()  {
    ...
    function add_plugin($plugin_array) {    
        ...
        $plugin_array[$this->plugin_name] =  plugins_url( 'includes/' . $this->plugin_dir . '/plugin.js', dirname( __FILE__ ) );
