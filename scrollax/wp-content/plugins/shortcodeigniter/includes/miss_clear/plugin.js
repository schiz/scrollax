(function() {
	var command_name = 'miss_mce_command-clear';
	var plugin_name = 'miss_mce_plugin_shortcode_clear';
...
//console.log(test)
	...
	// Register plugin
	tinymce.PluginManager.add( plugin_name, tinymce.plugins.miss_mce_plugin_shortcode_clear );
