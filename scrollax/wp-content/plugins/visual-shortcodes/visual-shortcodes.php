...
class JPB_Visual_Shortcodes {
	...
	function styles($hook) {
		if( 'post.php' == $hook || 'post-new.php' == $hook )
			wp_enqueue_style('jpb_visualshortcodes', plugins_url('/visual-shortcodes/buttons.css', dirname( __FILE__ ) ) );
	}
	...
	function plugins($plugins) {
		$plugins['visualshortcodes'] = plugins_url( '/visual-shortcodes/visualshortcodes/editor_plugin.js', dirname( __FILE__ ) );
		return $plugins;
	}
